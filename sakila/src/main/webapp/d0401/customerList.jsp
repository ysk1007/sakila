...
<% 
	...
	String searchWord = "";
	String jsp = "/sakila/d0401/customerList.jsp";
	String[] col = {"ID","name","address","zip code","phone","city","country","notes","SID"};
	...
	String sql = "SELECT COUNT(*) count "
				+" FROM customer"
				+" WHERE CONCAT(customer.first_name,customer.last_name) LIKE ?";
	...
	sql = "SELECT "
			...
			+" CASE WHEN cs.`active` = 1 THEN 'active'"
					+" ELSE '' "
			+" END AS 'notes',"
			+" cs.store_id AS SID"
		+" FROM customer cs"
...
<body>
	...
	<!-- 검색 -->
	<form action="<%=jsp%>">
		고객 이름 : <input type="text" name="searchWord" value="<%=searchWord%>">
